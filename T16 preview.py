...
# ------------------------------------------------------------------
# RESET PREVIEW CACHE WHEN SELECTED SLIDES CHANGE
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Generate preview ONCE per payload (LLM-safe)
# ------------------------------------------------------------------
if "preview_slides" not in st.session_state:
    ...
    for slide in slides:
        ...
        if "What should be the title of this presentation?" in user_answers:
            ...
            # --------------------------------------------------
            # CASE 2: No answers provided → TITLE ONLY
            # --------------------------------------------------
...
with col2:
    if st.button("🎯 Generate PPT"):
        # 🔑 Use preview slides as final source
