...
# ------------------------------------------------------------------
# 🔑 FORCE STREAMLIT TO APPLY JS EDITS BEFORE NAVIGATION
# ------------------------------------------------------------------
if st.session_state.pop("_sync_preview_before_generate", False):
...
with col2:
    if st.button("🎯 Generate PPT"):
        st.session_state["_sync_preview_before_generate"] = True
