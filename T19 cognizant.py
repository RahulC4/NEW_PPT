...
def clone_slide(prs, slide):
    ...
    # Deep copy shapes from master slide
...
def update_footer(slide):
    ...
    for ph in slide.placeholders:
        if ph.placeholder_format.type == 10:  # FOOTER
...
# ------------------------------------------------------------
def cleanup_click_to_add(slide):
...
# ------------------------------------------------------------
# TITLE SLIDE ONLY (UNCHANGED LOGIC)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# CONTENT SLIDE TITLE (FIX: PRESERVE COLOR)
# ------------------------------------------------------------
def set_content_title(slide, title):
    ...
    p.text = title              # keeps template color
...
def generate_presentation_cognizant(payload):
    ...
    content_master = prs.slides[3]   # 👈 4th slide design
    ...
    cleanup_click_to_add(title_slide)
    ...
    cleanup_click_to_add(thank_slide)
