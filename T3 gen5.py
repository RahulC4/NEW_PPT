...
if "last_generated_ppt" not in st.session_state:
    st.session_state["last_generated_ppt"] = None
...
if st.button("🎯 Generate PPT"):
    try:
        with st.spinner("Generating PPT..."):
            ...
            # ---------------- SESSION INSERT (NO DUPLICATES) ----------------
            if st.session_state["last_generated_ppt"] != out_path:
                ...
                st.session_state["last_generated_ppt"] = out_path
