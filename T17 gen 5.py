...
# ------------------------------------------------------------
# CLEANUP: delete old generated PPTs ONLY
# ------------------------------------------------------------
def cleanup_old_generated_ppts(
    folder="generated",
    max_age_minutes=60
):
    """
    Deletes .pptx files older than max_age_minutes from /generated.
    Safe: touches ONLY generated PPTs.
    """
...
if not already_generated:
    try:
        ...
        cleanup_old_generated_ppts(max_age_minutes=60)
